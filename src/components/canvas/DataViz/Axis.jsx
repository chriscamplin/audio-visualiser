...
const circular = (denominator, sliceOfPi, textScale) =>
  [...Array(3)].map((_, i) => {
...
export default function Axis({ step1Complete, textScale }) {
  ...
  return !step1Complete
    ? circular(denominator, sliceOfPi, textScale)
    : lines(textScale)
}
